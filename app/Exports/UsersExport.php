    ...
    */
    public function collection()
    {
        ...
        foreach ($data as $candidat) {
            ...
            // 'matiere_user.*', 'matieres.*')
            $matieres=DB::table('matiere_user')->select('DISTINCT(matiere_user.matiere_id)', 'matiere_user.user_id', 'matiere_user.note', 'matieres.name', 'filiere_matiere.filiere_id')
            ...
            ->groupBy('DISTINCT(matiere_user.matiere_id)')
            ->get();

...
<form class="container" action="/server.php/filiere_create" method="POST"  enctype="multipart/form-data" >
    @csrf
    <div class="row align-items-start">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="filiere_name" id="filiere_name" placeholder="nom de filiere" class="@error('name') is-invalid @enderror" required>
            @error('name')

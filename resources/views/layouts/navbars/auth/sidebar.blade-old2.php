<aside class="sidenav navbar navbar-vertical navbar-expand-xs fixed-start" style="background-color:#0f233a" id="sidenav-main">
  <div class="py-2 mb-4">
    <a class="d-flex align-items-center justify-content-center" href="{{ route('dashboard') }}">
      <img src="../assets/img/logo.png" class="" width="100" alt="logo">
    </a>
  </div>
    ...
    <ul class="navbar-nav text-ligh">
      ...
      @if(auth()->user()->role != "admin")
        ...
        <li class="nav-item">
          <a class="nav-link {{ (Request::is('user-profile') ? 'active' : '') }}" href="{{ url('user-profile') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fa fa-lg fa-user ps-2 pe-2 text-center text-dark {{ (Request::is('user-profile') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('user-management') ? 'active' : '') }}" href="{{ url('candidats') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-user-plus ps-2 pe-2 text-center text-dark {{ (Request::is('user-management') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
            <span class="nav-link-text ms-1">Candidatures</span>
        </a>
      </li>
      @endif
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('filiere') ? 'active' : '') }}" href="{{ url('filiere') }}">
          ...
          <span class="nav-link-text ms-1">Gestion des Filières </span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('matiere') ? 'active' : '') }}" href="{{ url('matiere') }}">
          ...
          <span class="nav-link-text ms-1">Gestion des Matières</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('bac') ? 'active' : '') }}" href="{{ url('bac') }}">
          ...
          <span class="nav-link-text ms-1">Gestion des Baccalauréats</span>
        </a>
      </li>
    </ul>
    <div class="dropdown dropup pb-4 position-absolute bottom-0">
      <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser" data-bs-toggle="dropdown" aria-expanded="false">
        <i class="fa fa-user-circle h2"></i>
      </a>
      <ul class="dropdown-menu" aria-labelledby="dropdownUser">
        <li><a class="dropdown-item" href="{{ url('user-profile') }}"><i class="fas fa-user opacity-6 me-1"></i>Profile</a></li>
        <li><a class="dropdown-item" href="{{ url('logout') }}"><i class="fas fa-key opacity-6 me-1"></i>Se déconnecter</a></li>
      </ul>
    </div>
    @endif

    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-dark active text-capitalize" aria-current="page"><?php echo html_entity_decode(str_replace('-', ' ', Request::path()), ENT_HTML5, 'ISO-8859-1') ?> /</li>
            </ol>
        </nav>

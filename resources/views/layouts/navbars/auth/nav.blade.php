    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-dark active text-capitalize" aria-current="page"><?php echo htmlentities(str_replace('-', ' ', Request::path()), ENT_NOQUOTES, 'ISO-UTF-8-1') ?> /</li>
            </ol>
        </nav>

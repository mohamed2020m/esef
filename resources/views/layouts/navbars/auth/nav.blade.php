    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-dark active text-capitalize" id="bdc" aria-current="page">/</li>
            </ol>
        </nav>
...
<script>
    ...
    let a = document.querySelect('#bdc').innerHtml += decode(str_replace('-', ' ', Request::path()))
</script>
          ...
          <div class="row">
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-20 ">
                ...
                <h3 class="font-weight-bolder text-info text-gradient " style="width:500px">Plateforme de préinscription à l'Ecole Supérieure d'Education <br> et de Formation de l'Université Chouaîb Doukkali</h3>
                  <p class="mb-0">Créer un nouveau compte<br></p>
                  <p class="mb-0">OU Connectez-vous avec vos identifiants :</p>
                </div>
                <div class="card-body">
                ...
                <small class="text-muted" >Mot de passe oublié ? Réinitialisez votre mot de passe
                  ...
                  Vous n'avez pas de compte ?
                    <a href="inscription" class="text-info text-gradient font-weight-bold">S'inscrire</a>
                  </p>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                ...
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('../assets/img/curved-images/esef.jpeg')"></div>
              </div>
            </div>
          </div>
        </div>

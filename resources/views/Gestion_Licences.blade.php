            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <div>
                            <h5 class="mb-0"><i class="fa fa-lg fa-gear ps-2 pe-2 text-center text-dark" aria-hidden="true"></i>Gestion des Licences</h5>
                        </div>
                        <a href="/server.php/licence-create" class="btn btn-sm mb-0" type="button" style="background-color: #0f233a !important;color:white">+&nbsp; Nouvelle Licence</a>
                    </div>
                </div>
                        ...
                        <table class="table table-striped table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr class="align-middle" style="font-size: 18px;">
                                    ...
                                    <td class="text-center">
                                        <a href="{{url('/licence-update-'.$item->id)}}" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="modifier La Licence">

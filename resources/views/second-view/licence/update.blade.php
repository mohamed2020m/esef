...
@section('content')
    <div class="m-3">
        <a  id="backto" href="https://esef.toubkalit.com/server.php/licence"><i class="fa fa-lg fa-arrow-left ps-2 pe-2 text-center text-dark" aria-hidden="true"></i>Retour</a>
    </div>
    <div class="card mb-4 mx-4">
        ...
        <div class="card-body px-3 pt-0 pb-2">
            ...
            <form action="{{url('/licence/update/'.$item->id)}}" method="POST"  enctype="multipart/form-data">
                @csrf
